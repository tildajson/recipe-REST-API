...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 25,
            'price': '2.55',
            'ingredients': [{'name': 'Lemon'}, {'name': 'Tofu'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_filter_by_tags(self):
        ...
        tag2 = Tag.objects.create(user=self.user, name='Gluten Free')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Vegan Fish and Chips')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Vegan Chicken Pasta')
        in1 = Ingredient.objects.create(user=self.user, name='Kidney Beans')
        in2 = Ingredient.objects.create(user=self.user, name='Spaghetti')
